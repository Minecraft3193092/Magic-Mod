...
package net.mcreator.magicmod.world.inventory;
...
public class MagicsmartstorageUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public MagicsmartstorageUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(MagicmodModMenus.MAGICSMARTSTORAGE_UI.get(), id);
		...
		this.customSlots.put(-1, this.addSlot(new SlotItemHandler(internal, -1, 175, 18) {
			private final int slot = -1;
		}));
		this.customSlots.put(-2, this.addSlot(new SlotItemHandler(internal, -2, 175, 36) {
			private final int slot = -2;
		}));
		this.customSlots.put(-3, this.addSlot(new SlotItemHandler(internal, -3, 175, 54) {
			private final int slot = -3;
		}));
