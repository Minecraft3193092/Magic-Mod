...
package net.mcreator.magicmod.fluid.types;
...
public class MagicWaterFluidType extends FluidType {
	...
	public void initializeClient(Consumer<IClientFluidTypeExtensions> consumer) {
		consumer.accept(new IClientFluidTypeExtensions() {
			private static final ResourceLocation STILL_TEXTURE = new ResourceLocation("magicmod:block/magic_leaves"), FLOWING_TEXTURE = new ResourceLocation("magicmod:block/magic_wood_leaves");
